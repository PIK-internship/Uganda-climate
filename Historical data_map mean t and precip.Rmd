...
map_pr_hist <- ggplot() +
  ...
  scale_fill_gradientn("Rainfall, mm", values = c(0, 0.3,0.6, 1),  # values can twist the legend
...
map_t_hist <- ggplot() +
  ...
  scale_fill_gradientn("Temperature, C",limits=c(15,30), values = c(0, 0.4,0.6, 0.8, 1),  # values can twist the legend
